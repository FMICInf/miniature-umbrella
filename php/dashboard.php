...
// ===== Eventos para calendario: solicitudes confirmadas con rango horario y vehículo asignado =====
$events = [];
$stmt = $pdo->query(
    "SELECT 
...
<head>
  ...
  <style>
    ...
    /* Define aquí los colores según patentes de tus vehículos */
    .vehiculo-lrv301 { background-color: #1E90FF !important; }
    .vehiculo-mtb404 { background-color: #FF6347 !important; }
    .vehiculo-tyt2022sa { background-color: #32CD32 !important; }
    .vehiculo-sda12 { background-color: #FFD700 !important; }
    /* Agrega más colores/clases según tus vehículos */
